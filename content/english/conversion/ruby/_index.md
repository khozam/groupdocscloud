...
############################# Head ############################
head_title: "Ruby Document Converter Cloud SDK for PDF Word Excel HTML & Images"
head_description: "Convert documents and images with Ruby Cloud SDK & REST APIs. Convert Word, Excel, presentations, PDF, Visio, Project, HTML & email file formats."

############################# Header ############################
title: "Convert Documents with Ruby Cloud SDK"
description: "REST APIs & Ruby Cloud SDK for developers to convert images & documents among supported file formats."
button:
    enable: true
...
submenu:
    ...
    right:
        link_download: "https://github.com/groupdocs-conversion-cloud/groupdocs-conversion-cloud-ruby"
...
features:
    ...
    more_feature:
      ...
      # more_feature_loop
      - title: "Get all the supported file formats - Ruby"
        content: |
          ```ruby
